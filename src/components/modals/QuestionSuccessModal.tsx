...
export default function QuestionSuccessModal({ setShow }: Params): JSX.Element {
  return (
    <Modal animationType="none" visible transparent>
      <View style={{ flex: 1, justifyContent: 'center' }}>
        ...
        >
          ...
          >
            Thanks for entrusting us with your questions. We&apos;ll do our best
            to answer it this week!
          </Text>
          <View style={{ height: 56, marginBottom: 16 }}>
            <WhiteButton solidBlack label="OK" onPress={() => setShow(false)} />
          </View>
        </View>
      </View>
    </Modal>
