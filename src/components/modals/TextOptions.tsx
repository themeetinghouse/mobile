...
export default function TextOpts({
  modeCallback,
  fontScaleCallback,
  defaultMode,
  defaultFontScale,
    ...
    >
      <Animated.View
        style={{
          ...
          width: '100%',
          bottom: 0,
          height: 150 + (noBottomPadding ? 0 : safeArea.bottom),
          ...
          <TouchableOpacity
            style={[
              style.textWrapper,
              {
                ...
                backgroundColor:
                  fontScale === 1 ? Theme.colors.grey4 : 'transparent',
              },
            ]}
            onPress={() => toggleFontScale(1)}
          >
          ...
          <TouchableOpacity
            style={[
              style.textWrapper,
              {
                ...
                backgroundColor:
                  fontScale === 1.25 ? Theme.colors.grey4 : 'transparent',
              },
            ]}
            onPress={() => toggleFontScale(1.25)}
          >
          ...
          <TouchableOpacity
            style={[
              style.textWrapper,
              {
                ...
                backgroundColor:
                  fontScale === 1.5 ? Theme.colors.grey4 : 'transparent',
              },
            ]}
            onPress={() => toggleFontScale(1.5)}
          >
          ...
          <TouchableOpacity
            style={[
              style.textWrapper2,
              {
                paddingTop: isAndroid ? 0 : 2,
                backgroundColor:
                  mode === 'dark' ? Theme.colors.grey4 : 'transparent',
              },
            ]}
          ...
          <TouchableOpacity
            style={[
              style.textWrapper2,
              {
                paddingTop: isAndroid ? 0 : 4,
                backgroundColor:
                  mode === 'light' ? Theme.colors.grey4 : 'transparent',
              },
            ]}
