...
function DateRangeSelectScreen({ navigation, startDate, endDate, dispatch }){

    let currentYear = moment().get("year");
    let startYear = moment(startDate || "2005-01-01").get("year");
    const years = [];
    ...
    const selectDateItem = (year, month) => {
