...
import { Container, Header, Content, Text, Left, Button, Body, Right, Icon, View, Thumbnail, Item, Input, List, ListItem, StyleProvider } from 'native-base';
...
function LocationSelectionScreen( { navigation, location, dispatch }) {
