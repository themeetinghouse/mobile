...
export default function AllSeriesScreen({ navigation }){
    ...
    const series = allSeries.items.filter(s => searchText ? s.title.toLowerCase().includes(searchText.toLowerCase()): true);
